...
define :kickMaker do
  ...
  2.times do
    7.times do
      ...
      sample :bd_haus, cutoff: rrand(100,130)
      sleep x
    end
  end
end
...
define :basslineMaker do
  ...
  128.times do
    ...
    play x, amp:y
    use_synth :pulse
    use_synth_defaults pulse_width: rrand(0.1,1), cutoff: 90
    play x, amp: y
    sleep 1
  end
end
...
with_fx :hpf, cutoff: 120 do
  with_fx :distortion do
    live_loop :chick do
      sample :elec_hi_snare, rate: 3, attack:0.2, amp: [1,0].choose
      sleep 2
    ...
    live_loop :chick2 do
      ...
      sleep 2
      sample :elec_mid_snare, rate: 3.5, attack:0.2, amp: [1,0].choose
      sleep 1
    end
  end
end
